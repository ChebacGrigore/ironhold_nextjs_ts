                  ...
                  <div className={loginForm? "login-box login-box-ironhold border widget-box visible": "login-box login-box-ironhold border widget-box"} >
                      <div className="widget-body">
                          <div className="widget-main background-white">
                              ...
                              <form name="mainLogin" id='login_form' onSubmit={handleSubmit} className="login-form ng-pristine ng-invalid ng-invalid-required">
                    ...
                    <div className="widget-body">
                        ...
                        <div className="toolbar center">
                            <div className="login-footer">
                                <a className="back-to-login-link" id='back_login' onClick={()=>setLoginForm(true)}>
                                    &lt; Back to login
                                </a>
                            </div>
                        </div>
